...
token ID
    ...
    :rax-identity:`Manage authentication tokens and token expiration <cloud-identity/v2/getting-started/manage-auth-tokens//#manage-authentication-tokens>`.
...
..  note::
       ...
       :rax-identity:`Identity API reference documentation
