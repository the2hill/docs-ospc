...
.. note::
     ...
     - :rax-identity:`Authentication token operations <cloud-identity/v2/api-reference/token-operations>`
     ...
     - :rax-identity:`Manage tokens and token expiration <cloud-identity/v2/getting-started/manage-auth-tokens>`
