...
extlinks = {
    ...
    'rax-identity': ('https://developer.rackspace.com/docs/%s', ''),
    'rax-devdocs': ('https://docs-ospc.rackspace.com/%s', ''),
    'rax-devguide':('https://docs-ospc.rackspace.com/%s/developer-guide/',''),
    'rax-api': ('https:/developer.rackspace.com/docs/%s/developer-guide/#api-reference',''),
...
rst_epilog = """
.. |service| replace:: Rackspace RackConnect
...
htmlhelp_basename = 'RackspaceCloudApiRackconnectDeveloperDoc'
...
latex_documents = [
  ('index', 'RackspaceCloudApiRackconnectDeveloperDoc.tex', 'Rackspace Rackconnect API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudApiRackconnectDeveloperDoc', 'Rackspace Rackconnect API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudApiRackconnectDeveloperDoc', 'Rackspace Rackconnect API Developer Guide',
   'Rackspace', 'RackspaceCloudApiRackconnectDeveloperDoc', 'Learn about using the REST API for the Rackspace Rackconnect service.',
   'Miscellaneous'),
]
