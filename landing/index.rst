...
.. raw:: html
   ...
   <section class="docs-category dev-tools" data-ng-show="isSectionActive('dev-tools')">
       ...
       <p>Rackspace provides access to our cloud services by using the Software Development Kit (SDK) of your choice. These SDKs are no longer actively supported.</p>
       <div class="product-list">
           <div class="product">
               <div class="card pink">
                   <div class="card-content">
                           ...
                           <div class="list">
                               <div class="list-column">
                                   <ul>
                                       ...
                                       <li><a href="/rack-cli/">Documentation</a></li>
