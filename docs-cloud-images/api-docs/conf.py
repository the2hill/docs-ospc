...
.. |product name| replace:: Cloud Images
"""
...
# html_title = 'Rackspace Cloud Images v2.0 documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'Rackspace Cloud Images v2.0 API'
...
htmlhelp_basename = 'docs-cloud-ImagesDoc'
