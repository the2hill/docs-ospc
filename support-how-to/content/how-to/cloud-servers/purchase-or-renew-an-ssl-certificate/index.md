...
After you [generate a certificate signing request (CSR)](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generate-a-csr), you can purchase a Secure Sockets Layer (SSL) certificate for your server. This article describes how to purchase a new SSL certificate or renew an existing certificate.
...
After you have purchased and validated your certificate, you're ready to [install it](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate).
