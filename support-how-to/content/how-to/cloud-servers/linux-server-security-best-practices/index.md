...
[Generate RSA keys with SSH PUTTYgen](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generating-rsa-keys-with-ssh-puttygen/)
and
[Log in with a SSH private key on Windows](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/logging-in-with-an-ssh-private-key-on-windows)
...
2.  Change the following lines:
    ...
    **Note**: By default, the `Port` and `PermitRootLogin` lines are commented out
    ...
    program by using [netstat](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/checking-listening-ports-with-netstat).
...
If you're connecting from a Windows desktop, when you create the connection in [PuTTY](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/connecting-to-linux-from-windows-by-using-putty), you can specify the port number and a private key.
...
procedures such as [checking for backdoors and intruders](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/check-for-a-security-compromise-back-doors-and-intruders)
and [rescue mode investigation](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/check-for-a-security-compromise-rescue-mode-investigation).
...
By using
[Role Based Access Control (RBAC)](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/overview-role-based-access-control-rbac),
...
For more information about RBAC, see the [Role-Based Access Control (RBAC) FAQ](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/faq-role-based-access-control-rbac/).
