...
If you want to obtain a CSR, refer to [How to generate a CSR](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generate-a-csr/). If you are renewing an SSL certificate and the organization’s information has not changed, you do not need a new CSR.
...
-  [How to generate a CSR](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generate-a-csr/)

-  [Purchasing an SSL certificate through Rackspace](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/rackspace-ssl-certificates/)
