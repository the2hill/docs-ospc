...
After you [generate a certificate signing request (CSR)](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generate-a-csr)
and [purchase or renew a Secure Socket Layer (SSL) certificate](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/purchase-or-renew-an-ssl-certificate/),
...
[Configure SSL certificates on Cloud Load Balancers](https://docs-ospc.rackspace.com/support/how-to/cloud-load-balancers/configure-SSL-certificates-on-cloud-load-balancers).

The following sections provide instructions for the installation process according to each platform:

- [Prerequisites](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#prerequisites)

- [Install certificate on Microsoft&reg; Windows&reg; 2008 R2 and 2012 servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#install-certificate-on-windows-servers)

- [Install certificate in Apache Web Server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#install-certificate-in-apache-web-server)

- [Install certificate in NGINX with php-fpm](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#install-certificate-in-nginx-with-php-fpm)

- [Install certificate on Managed Hosting solutions](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#install-certificate-on-managed-hosting-solutions)

- [Install certificate on a custom Microsoft&reg; Azure&reg; domain](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#install-certificate-on-a-custom-microsoft-azure-domain)

- [Test the certificate](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#test-the-certificate)
...
[Generate a CSR](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generate-a-csr/) and
...
[Import an SSL certificate from another server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/install-an-ssl-certificate/#import-an-ssl-certificate-from-another-server).
...
[Sitecore Cloud portals and account management](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/sitecore-cloud-portals-and-account-management/).
...
[generate a certificate signing request (CSR)](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generate-a-csr)
and [purchase or renew a Secure Socket Layer (SSL certificate](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/purchase-or-renew-an-ssl-certificate/).
