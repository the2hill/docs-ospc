...
guarantee](https://docs.rackspace.com/docs/managed-cloud-service-levels-faq) for Managed
...
- [Forced reboot checks that cause longer
  downtimes](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/ensure-servers-reboot-successfully/)
...
- Scale your databases and add
  [replication](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/database-replication-with-cloud-databases/). Your
...
- Rackspace Cloud Databases can help you with both scaling and
  [replication](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/database-replication-with-cloud-databases/).
