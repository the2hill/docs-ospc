...
the other. As a result, most of the tips in the [article about speeding up rsync](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/speed-up-rsync-when-migrating-a-linux-server-from-the-command-line) also apply here.
...
For information on running rsync manually, see either [Speed up rsync when migrating a Linux server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/speed-up-rsync-when-migrating-a-linux-server-from-the-command-line) or [Back up your files with rsync](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/backing-up-your-files-with-rsync/).
