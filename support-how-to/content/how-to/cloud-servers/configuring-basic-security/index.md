...
server, see [Create OnMetal Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/create-onmetal-cloud-servers)
...
Windows instructions, see [Key generation using Putty forWindows](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/generating-rsa-keys-with-ssh-puttygen).
...
-   If you've been rebuilding the server, you might need to [remove the host key from your known_hosts file](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/rackspace-cloud-essentials-checking-a-server-s-ssh-host-fingerprint-with-the-web-console) before
...
up security.  See [Windows Cloud Server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/log-in-to-your-server-via-rdp-windows) to
