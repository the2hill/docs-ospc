...
- Windows: [Prepare to migrate a Windows server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/prepare-to-migrate-a-windows-server/#ensureAutoStart)
