...
in [Prepare to migrate a Linux server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/prepare-to-migrate-a-linux-server)
or [Prepare to migrate a Windows server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/prepare-to-migrate-a-windows-server/).
...
[article](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/considerations-for-migrating-to-a-general-purpose-or-io-cloud-server/).
...
[this article](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/create-an-image-of-a-server-and-restore-a-server-from-a-saved-image)
...
The [open cloud reference architectures](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/rackspace-open-cloud-reference-architecture)
...
[adding one or more Cloud Block Storage volumes](https://docs-ospc.rackspace.com/support/how-to/cloud-block-storage/create-and-attach-a-cloud-block-storage-volume)
to the new server.
...
- [Prepare data disks on a Windows Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/preparing-data-disks-on-windows-cloud-servers)
- [Prepare data disks on a Linux Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/preparing-data-disks-on-linux-cloud-servers)
...
To migrate particular directories, you can use [Cloud Backup](https://docs-ospc.rackspace.com/support/how-to/cloud-backup).
Create a backup of your data on the origin server and then restore it to the
destination server.

#### Cloud Block Storage

To migrate specific data, you can use [Cloud Block Storage](https://docs-ospc.rackspace.com/support/how-to/cloud-block-storage/cloud-block-storage-overview).
...
For more information about rsync, see [Back up your files with rsync](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/backing-up-your-files-with-rsync).
...
[Migrating a Linux server from the command line](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/migrating-a-linux-server-from-the-command-line-1).
...
Web Deploy tool. See [Launch a Windows Web Farm with Web Deploy](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/launch-a-windows-web-farm-with-web-deploy).
