...
**Note**: For more information about the `netstat` command, see [Check listening ports with netstat](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/checking-listening-ports-with-netstat).
...
If you can’t start your service, [review your logs](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/linux-log-files) to
see if they contain information about the issue.

### Next steps

After you're sure that the application is running, check the
[server resources](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/checking-system-load-on-linux) to verify how much
