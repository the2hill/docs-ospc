...
needed. For a comparison of the two data disk backup options, see [Best Practices for Backing Up Your Data: Cloud Block Storage versus Cloud Backup](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/best-practices-for-backing-up-your-data-cloud-block-storage-versus-cloud-backup).
...
see [Work-optimized server types](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/new-features-in-general-purpose-and-work-optimized-cloud-servers/#work-optimized-server-types).
...
or changing the size of your work-optimized server, see [Upgrading resources for General Purpose or I/O optimized Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/upgrading-resources-for-general-purpose-or-io-optimized-cloud-servers).
...
-   [Preparing Data Disks on Windows Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/preparing-data-disks-on-windows-cloud-servers)
-   [Preparing Data Disks on Linux Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/preparing-data-disks-on-linux-cloud-servers)
