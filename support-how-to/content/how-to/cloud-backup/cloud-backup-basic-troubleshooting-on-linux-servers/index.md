...
**Note:** If your server is running a Windows&reg; operating system, see [Cloud backup troubleshooting on Windows](https://docs-ospc.rackspace.com/support/how-to/cloud-backup/cloud-backup-basic-troubleshooting-on-window-2008-servers/). 
...
4. Follow these steps based on the status:
   ...
   - If the status is **disconnected**, download the log from the server that
     ...
     article](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/transfer-files-to-or-from-a-linux-server-without-ftp)).
