...
Instead, see the documentation for the [standard RCBU Linux updater](https://docs-ospc.rackspace.com/support/how-to/cloud-backup/update-or-install-the-cloud-backup-agent-on-linux/).
...
[Manually update the Rackspace Cloud Backup agent](https://docs-ospc.rackspace.com/support/how-to/cloud-backup/update-the-rackspace-cloud-backup-agent).
...
**Next step:** [Create a backup](https://docs-ospc.rackspace.com/support/how-to/cloud-backup/rackspace-cloud-backup-create-a-backup)
