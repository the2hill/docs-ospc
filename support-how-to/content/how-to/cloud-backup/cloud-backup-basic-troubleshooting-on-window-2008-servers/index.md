...
**Note:** If your server is running a Linux&reg; operating system, see [Cloud backup troubleshooting on Linux](https://docs-ospc.rackspace.com/support/how-to/cloud-backup/cloud-backup-basic-troubleshooting-on-linux-servers). 
