...
or a [Rackspace Cloud Load Balancer](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/connect-to-a-cloud-databases-instance#lb).
...
1.  Use the [Cloud Control Panel](https://login.rackspace.com/),
    ...
    and password to access it.
      ...
      **Note:** If you want to enable external access by using an HA instance
      ...
      [Manage Cloud Databases HA instance groups in the Cloud Control Panel](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/manage-cloud-databases-ha-groups-in-the-cloud-control-panel/)
      for more detailed instructions.

2.  If you need to change any configuration parameters, do so by using
    [configuration groups](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/managing-cloud-databases-configuration-groups-in-the-cloud-control-panel)
...
2.  On the machine where your existing database is located, run the
    ...
    **Note**: If you are exporting from a Cloud Databases instance, see
    [exporting data](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/exporting-data-from-mysql) for information about
...
[Upgrade a Cloud Databases instance from MySQL 5.1 to MySQL 5.6](https://docs-ospc.rackspace.com/support/how-to/cloud-databases/upgrade-a-cloud-databases-instance-from-mysql-51-to-mysql-56).
