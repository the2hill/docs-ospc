...
7. Choose the protocol and port that you want to use. The port adjusts to the
    ...
    **Note**: For more information about the protocols that you can choose
    ...
    Protocol](https://docs-ospc.rackspace.com/support/how-to/cloud-load-balancers/available-protocols-when-configuring-a-cloud-load-balancer).
...
**Next steps:** [Cloud Files and the Content Delivery Network](https://docs-ospc.rackspace.com/support/how-to/cloud-files/getting-started-with-cloud-files-and-cdn/)
