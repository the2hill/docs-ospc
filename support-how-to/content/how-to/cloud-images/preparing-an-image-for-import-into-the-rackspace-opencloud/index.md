...
- [Swiftly](https://docs-ospc.rackspace.com/support/how-to/cloud-files/install-the-swiftly-client-for-cloud-files/)
...
For the next steps, you need [Swiftly](https://docs-ospc.rackspace.com/support/how-to/cloud-files/install-the-swiftly-client-for-cloud-files/),
...
| xenapi_use_agent | False | Don't use [the nova-agent](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/nova-agent-unix-and-rackspace-agent-windows/) to set up the server. |
...
Use the [emergency console](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/start-a-console-session/) to
