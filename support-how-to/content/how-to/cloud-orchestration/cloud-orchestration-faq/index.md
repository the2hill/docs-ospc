...
[Change your server root/admin password from your account](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/support/how-to-change-your-server-rootadmin-password-from-your-account).
{{< /accordion >}}
...
see [Connect to a cloud server](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/connect-to-a-cloud-server).
{{< /accordion >}}
...
stack, see the [Rackspace Monitoring FAQ](https://docs.rackspace.com/docs/rackspace-monitoring-faq).
...
Operations](https://docs.rackspace.com/docs/linux-spheres-of-support-for-dedicated-and-managed-ops)
