...
-   [What is new with OnMetal Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/what-is-new-with-onmetal-cloud-servers)
-   [Using OnMetal Cloud Servers](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/create-onmetal-cloud-servers)
-   [Using OnMetal Cloud Servers through API](https://docs-ospc.rackspace.com/support/how-to/cloud-servers/using-onmetal-cloud-servers-through-api)
...
-   When using one of the portals to create RackConnect cloud servers,
    ...
    you can also use the [Cloud Servers API](https://docs-ospc.rackspace.com/support/how-to/rackconnect/using-onmetal-cloud-servers-through-api)
...
-   Even though OnMetal servers require the use of SSH keys, the RackConnect automation systems still create and use a "rackconnect" user account for administering the OnMetal servers. Do not disable, modify, or remove this user account. Additionally, the other [RackConnect best practices](https://docs-ospc.rackspace.com/support/how-to/rackconnect/rackconnect-v20-best-practices) still apply to OnMetal servers.
