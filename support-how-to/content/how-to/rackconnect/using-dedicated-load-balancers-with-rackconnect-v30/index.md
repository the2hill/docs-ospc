...
<img src="Fig1-Ded.-LB-and-RCv3-Figure-Traffic-Flow-PNG-.5xhalf-border.png" alt="" title="">
...
2.  In the pop-up dialog box, select the check box for each load balancer pool to which you want to add the cloud server.
    ...
    <img src="Fig3_REACH_LB_Pool_Modal_PNG_smaller-border.png" alt="" title="">
...
is available on the [Contact Us](https://docs.rackspace.com/docs/support) page.
