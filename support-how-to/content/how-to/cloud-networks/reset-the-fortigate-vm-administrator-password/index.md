...
1. Navigate to the [emergency console](https://docs-ospc.rackspace.comhttps://docs-ospc.rackspace.com/support/how-to/cloud-networks/cloud-servers/start-a-console-session/).
