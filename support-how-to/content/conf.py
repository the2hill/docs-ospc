...
.. |service| replace:: how-to's
.. |apiservice| replace:: how-to's
.. |no changes| replace:: None for this release
.. |contract version| replace:: 1.0
.. |product name| replace:: how-to's
"""
...
# html_short_title = 'OSPC How-To Articles'
...
latex_documents = [
  (master_doc, 'docs-how-to.tex',
   'OSPC How-To Articles',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'OSPC How-To Articles',
     'OSPC How-To Articles',
     'Rackspace', 1)
]
...
texinfo_documents = [
  (master_doc, 'docs-how-to', 'OSPC How-To Articles',
   'Rackspace', 'docs-how-to', 'OSPC How-To Articles',
   'Miscellaneous'),
]
