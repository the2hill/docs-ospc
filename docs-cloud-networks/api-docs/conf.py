...
project = 'Rackspace Cloud Networks'
copyright = '2015'
author = 'Rackspace'
...
# html_title = 'Rackspace Cloud Networks version 2.0 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'Rackspace Cloud Networks'
...
htmlhelp_basename = 'docs-cloud-networksdoc'
...
latex_documents = [
  (master_doc, 'docs-cloud-networks.tex',
  'Rackspace Cloud Networks API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Networks API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-networks',
   'Rackspace Cloud Networks API Documentation', 'Rackspace',
   'docs-cloud-networks', 'Learn about using the Rackspace Cloud Networks',
   'Miscellaneous'),
]
